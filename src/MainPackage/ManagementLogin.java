...
public class ManagementLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Login page for management");
        ...
        if (jtxtUsername.getText().equals("") && jtxtPassword.getText().equals("")) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(null, "Username or password false", "Message", JOptionPane.ERROR_MESSAGE);
                }
            } catch(SQLException e) {
                Logger.getLogger(ManagementLogin.class.getName()).log(Level.SEVERE, null, e);
            }
        }
